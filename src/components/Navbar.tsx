    ...
    return (
        <div
            style={{
                ...
                backgroundColor: "#1c1c28c7"
            }}
            className="sticky top-0 z-50  py-5 md:py-4 px-6 md:px-10 flex justify-between items-center flex-row flex-wrap"
            data-aos="fade-down"
            data-aos-delay="-500"
        >
            <div className="w-full md:w-auto inline-flex justify-between items-center">
                <Link
                    to="/"
                    className="text-white inline-block font-bold text-2xl"
                >
         ...
         overflow-hidden md:overflow-visible`}
            >
                {navLinks.map((link, _) => (
                    <div
                        className="block md:inline-block my-7 md:my-0"
                        key={_.toString()}
                    >
                        <Link
                            onClick={handleNavbarToggle}
